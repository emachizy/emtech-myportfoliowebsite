...
const About = () => {
  ...
  return (
    <>
      <HeroBanner
        title="About Us"
        subtitle="Learn more about our journey, values, and the team dedicated to delivering exceptional web solutions."
        backgroundImage="/images/hero-img/about-img.webp"
        breadcrumbs={["About"]}
      />
      <motion.section
      ...
      >
        ...
        <div className="relative w-full max-w-[95vw] mx-auto my-10 rounded-4xl bg-gray-100 pt-10 pb-24">
          <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 py-2 px-4">
            {/* Image Section */}
            ...
            <div className="flex-1 space-y-4 text-center md:text-left">
              ...
              <p className="text-gray-600 text-base leading-relaxed max-w-xl">
                ...
                functional websites. I specialize in front-end development, but
